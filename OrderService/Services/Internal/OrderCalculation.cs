     ...
     out decimal grandTotal)
        {
            ...
            // 6️⃣ Grand total (subtotal + tax + charge - discount)
            decimal tempGrandTotal = tempSubTotal + tempTaxTotal + tempChargeTotal - tempDiscountTotal;
